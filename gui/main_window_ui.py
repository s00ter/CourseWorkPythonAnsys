...
# Form implementation generated from reading ui file 'main_win_layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.settingsBox = QtWidgets.QToolBox(self.centralwidget)
        ...
        self.settingsBox.setMaximumSize(QtCore.QSize(16777215, 211))
        self.settingsBox.setObjectName("settingsBox")
        self.pageBracket = QtWidgets.QWidget()
        self.pageBracket.setGeometry(QtCore.QRect(0, 0, 628, 130))
        self.pageBracket.setObjectName("pageBracket")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.pageBracket)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.scrollArea_2 = QtWidgets.QScrollArea(self.pageBracket)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 591, 217))
        ...
        self.youngaParameter = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.poissonParameter = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.thicknessParameter = QtWidgets.QLineEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.powerValue = QtWidgets.QLineEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.setupBraketParametersBtn = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        ...
        self.verticalLayout_7.addWidget(self.setupBraketParametersBtn)
        ...
        self.settingsBox.addItem(self.pageBracket, "")
        self.pageMesh = QtWidgets.QWidget()
        self.pageMesh.setEnabled(False)
        self.pageMesh.setGeometry(QtCore.QRect(0, 0, 98, 89))
        self.pageMesh.setObjectName("pageMesh")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.pageMesh)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(self.pageMesh)
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(9, 9, 591, 221))
        ...
        self.settingsBox.addItem(self.pageMesh, "")
        self.pageLF = QtWidgets.QWidget()
        self.pageLF.setEnabled(False)
        self.pageLF.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pageLF.sizePolicy().hasHeightForWidth())
        self.pageLF.setSizePolicy(sizePolicy)
        self.pageLF.setMaximumSize(QtCore.QSize(16777215, 211))
        self.pageLF.setObjectName("pageLF")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.pageLF)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.scrollArea_3 = QtWidgets.QScrollArea(self.pageLF)
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName("scrollArea_3")
        self.scrollAreaWidgetContents_3 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 463, 263))
        self.scrollAreaWidgetContents_3.setObjectName("scrollAreaWidgetContents_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_3)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.fixParametersBox = QtWidgets.QGroupBox(self.scrollAreaWidgetContents_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.fixTypeBox = QtWidgets.QComboBox(self.fixParametersBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_6 = QtWidgets.QLabel(self.fixParametersBox)
        ...
        self.label_7 = QtWidgets.QLabel(self.fixParametersBox)
        ...
        self.edgeLeftFixCheckBox = QtWidgets.QCheckBox(self.fixParametersBox)
        ...
        self.edgeRightFixCheckBox = QtWidgets.QCheckBox(self.fixParametersBox)
        ...
        self.edgeDiagonalFixCheckBox = QtWidgets.QCheckBox(self.fixParametersBox)
        ...
        self.label_5 = QtWidgets.QLabel(self.fixParametersBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.gridLayout_3.addWidget(self.fixParametersBox, 0, 0, 1, 1)
        ...
        self.settingsBox.addItem(self.pageLF, "")
        self.verticalLayout.addWidget(self.settingsBox)
        self.gridLayout.addLayout(self.verticalLayout, 0, 0, 1, 1)
        self.plotLayout = QtWidgets.QVBoxLayout()
        self.plotLayout.setContentsMargins(-1, 0, -1, -1)
        self.plotLayout.setObjectName("plotLayout")
        self.gridLayout.addLayout(self.plotLayout, 1, 0, 1, 1)
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.bracketParametersText = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Параметры материала"))
        self.label_2.setText(_translate("MainWindow", "Коэффициент Юнга (Модуль упругости):"))
        self.youngaParameter.setText(_translate("MainWindow", "1.1e11"))
        self.label_3.setText(_translate("MainWindow", "Коэффициент Пуассона (жёсткость):"))
        self.poissonParameter.setText(_translate("MainWindow", "0.34"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Свойства"))
        ...
        self.powerValue.setText(_translate("MainWindow", "200"))
        self.setupBraketParametersBtn.setText(_translate("MainWindow", "Установить параметры"))
        self.settingsBox.setItemText(self.settingsBox.indexOf(self.pageBracket), _translate("MainWindow", "Параметры балки"))
        ...
        self.settingsBox.setItemText(self.settingsBox.indexOf(self.pageMesh), _translate("MainWindow", "Настройки сетки"))
        ...
        self.settingsBox.setItemText(self.settingsBox.indexOf(self.pageLF), _translate("MainWindow", "Нагрузки и закрепления"))
